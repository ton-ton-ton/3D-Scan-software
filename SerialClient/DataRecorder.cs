    ...
    public partial class DataRecorder : Form
    {
        ...
        private void BTN_RECORD_Click(object sender, EventArgs e)
        {
            if (isRunning)
            {
                ...
                RdgEndTime = Convert.ToDouble(DB.GetTimeMs()) / 1000.0;
                SW.Stop();
            ...
            {
                RdgStartTime = Convert.ToDouble(DB.GetTimeMs()) / 1000.0;
                SW.Start();
        ...
        private void DataRecorder_FormClosing(object sender, FormClosingEventArgs e)
        {
        }

        private void DataRecorder_Load(object sender, EventArgs e)
        {
